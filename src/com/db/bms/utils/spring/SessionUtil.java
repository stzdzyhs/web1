package com.db.bms.utils.spring;
...
public final class SessionUtil {
    ...
    private static final String ACTIVE_OPERATOR = "activeOperator";//用户
     ...
     * @return SysUser
     */
    public static Operator getActiveOperator(HttpServletRequest request) {
        Object o = request.getSession(true).getAttribute(ACTIVE_OPERATOR);
        if (o == null)
            return null;
        return (Operator) o;
    }
