...
initToolTips();
function autoSetTImg(){
	var toolTipImg = document.getElementById("toolTipImg");
	if(toolTipImg!=null && typeof(toolTipImg)!="undefined"){
		var image=new Image();
		image.onload = function(){
			var height = image.height, width = image.width;
			if(width>400 || height>400){
				toolTipImg.style.width = width*0.7+"px";
				toolTipImg.style.height = height*0.7+"px";
				toolTipImg.style.maxHeight = height*0.7+"px";
			}
		};
/*		image.src=toolTipImg.src;
		var height = image.height, width = image.width;
		if(width>400 || height>400){
			toolTipImg.style.width = width*0.7+"px";
			toolTipImg.style.height = height*0.7+"px";
